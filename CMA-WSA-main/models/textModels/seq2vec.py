...
if __name__ == '__main__':
    ...
    skip = factory(vocab, {'arch': 'skipthoughts', 'dir_st': './skip-thoughts',
                           'type': 'BayesianUniSkip', 'dropout': 0.25, 'fixed_emb': False}).cuda()
    ...
    skip.eval()
    output, cell1 = skip(myinput)
    print(output)
    print(cell1)

    # batch_size x 2400
    output_seq2vec, cell2 = skip(myinput, lengths=[7, 6, 5])
